...
class Newton(CoreService):
    ...
    _configs = ('tracks.cfg',
                'data/exes/TEST1961.exe.xml',
                'data/traf/TEST1961.trf.xml',
    ...
    def generateconfig(cls, node, filename, services):
        ...
        if filename == "data/exes/TEST1961.exe.xml":
            cfg = ""
            cfg += "<?xml version='1.0' encoding='UTF-8'?>\n"
            cfg += "<!DOCTYPE exercicios>\n"
            cfg += '<exercicios VERSION="0001" CODE="1961" FORMAT="NEWTON">\n'
            cfg += "\n"
            cfg += '    <exercicio nExe="TEST1961">\n'
            cfg += "        <descricao>Teste de Cinematica</descricao>\n"
            cfg += "        <horainicio>06:00</horainicio>\n"
            cfg += "    </exercicio>\n"
            cfg += "\n"
            cfg += "</exercicios>\n"

        if filename == "data/traf/TEST1961.trf.xml":
            cfg = ""
            cfg += '<?xml version="1.0" encoding="UTF-8"?>\n'
            ...
            cfg += '    	<procedimento>TRJ001</procedimento>\n'
