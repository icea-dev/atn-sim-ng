...
class EvilTwinCallsign(AbstractAttack):
    """
    Classe responsável pelo ataque de spoofing que altera o CALLSIGN, a LATITUDE e o ENDEREÇO ICAO da
    ...
    def __init__(self):
        ...
        Construtor
        """
        M_LOG.info(">> EvilTwinCallsign.__init__")
    ...
    def spy(self, fdct_aircraft_table=None, flst_icao24_fake=None):
        ...
        :return: None.
        """
        M_LOG.info(">> EvilTwinCallsign.spy")
    ...
    def __str__(self):
        ...
        """
        return "CyberAttack::EvilTwinCallsign"
